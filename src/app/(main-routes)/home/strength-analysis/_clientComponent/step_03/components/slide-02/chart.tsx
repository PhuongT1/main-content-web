...
import { dataParent, secondList, slide_02_colors, thirdList } from '@/constants/strength-analysis.constant'
...
const DoughnutChartSlide_02: FC<PropPieChart> = ({ labels, data, backgroundColor, options }) => {
  const dataPieChart: ChartData<'doughnut', number[], string> = {
    datasets: [
      {
        backgroundColor: slide_02_colors,
...
export default DoughnutChartSlide_02
