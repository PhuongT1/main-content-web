...
const SettingSmIcon = ({ svgProps, gProps }: SvgComponentProps) => (
  <svg xmlns='http://www.w3.org/2000/svg' width={18} height={18} fill='none' {...svgProps}>
    <g stroke='#fff' strokeLinecap='round' strokeLinejoin='round' {...gProps}>
